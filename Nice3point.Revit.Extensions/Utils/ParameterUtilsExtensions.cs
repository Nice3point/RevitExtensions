...
public static class ParameterUtilsExtensions
{
    ...
    [Pure]
    public static ForgeTypeId GetParameterTypeId(this BuiltInParameter builtInParameter)
    {
    ...
    /// </exception>
    [Pure]
    public static BuiltInParameter GetBuiltInParameter(this ForgeTypeId parameterTypeId)
    {
    ...
    /// </returns>
    [Pure]
    public static bool IsBuiltInGroup(this ForgeTypeId groupTypeId)
    {
        return ParameterUtils.IsBuiltInGroup(groupTypeId);
    }
    ...
    [Pure]
    public static bool IsBuiltInParameter(this ForgeTypeId parameterTypeId)
    {
    ...
    [Pure]
    public static bool IsBuiltInParameter(this Parameter parameter)
    {
    ...
    /// </param>
    /// <param name="parameterTypeId">Parameter identifier.</param>
    ...
    /// </exception>
    public static string DownloadCompanyName(this ForgeTypeId parameterTypeId, Document document)
    {
    ...
    ///    Thrown when the user is not signed in.
    /// </exception>
    public static ParameterDownloadOptions DownloadParameterOptions(this ForgeTypeId parameterTypeId)
    {
    ...
    /// </exception>
    [Pure]
    public static SharedParameterElement DownloadParameter(this ForgeTypeId parameterTypeId, Document document, ParameterDownloadOptions options)
    {
