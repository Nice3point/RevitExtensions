...
public static class UnitFormatUtilsExtensions
{
...
#endif
    public static string FormatUnit(this Units units, UnitType unitType, double value, bool maxAccuracy, bool forEditing)
    {
    ...
    [Obsolete("This method is deprecated in Revit 2021")]
#endif
    public static string FormatUnit(this Units units, UnitType unitType, double value, bool maxAccuracy, bool forEditing, FormatValueOptions options)
    {
