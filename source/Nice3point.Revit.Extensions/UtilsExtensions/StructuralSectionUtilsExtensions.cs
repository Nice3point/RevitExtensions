...
public static class StructuralSectionUtilsExtensions
{
    ...
    {
        /// <inheritdoc cref="Autodesk.Revit.DB.Structure.StructuralSections.StructuralSectionUtils.GetStructuralElementDefinitionData(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ElementId,out Autodesk.Revit.DB.Structure.StructuralSections.StructuralElementDefinitionData)"/>
        [Pure]
