...
public static class CurveByPointsUtilsExtensions
{
    ...
    extension(CurveElement curveElement)
    {
        ...
        /// <inheritdoc
        ///     cref="Autodesk.Revit.DB.CurveByPointsUtils.CreateRectangle(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ReferencePoint,Autodesk.Revit.DB.ReferencePoint,Autodesk.Revit.DB.CurveProjectionType,System.Boolean,System.Boolean,out System.Collections.Generic.IList{Autodesk.Revit.DB.ElementId},out System.Collections.Generic.IList{Autodesk.Revit.DB.ElementId})" />
        public static void CreateRectangle(Document document, ReferencePoint startPoint, ReferencePoint endPoint, CurveProjectionType projectionType, bool boundaryReferenceLines, bool boundaryCurvesFollowSurface,
            out IList<ElementId> createdCurvesIds, out IList<ElementId> createdCornersIds)
        {
