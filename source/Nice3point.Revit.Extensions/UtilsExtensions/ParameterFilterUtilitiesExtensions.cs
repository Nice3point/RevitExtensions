...
public static class ParameterFilterUtilitiesExtensions
{
    ...
    extension(ParameterFilterElement parameterFilter)
    {
        ...
        /// <inheritdoc
        ///     cref="Autodesk.Revit.DB.ParameterFilterUtilities.GetInapplicableParameters(Autodesk.Revit.DB.Document,System.Collections.Generic.ICollection{Autodesk.Revit.DB.ElementId},System.Collections.Generic.IList{Autodesk.Revit.DB.ElementId})" />
        [Pure]
