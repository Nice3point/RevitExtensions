...
public static class ParameterUtilsExtensions
{
    ...
    {
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.IsBuiltInParameter(Autodesk.Revit.DB.ForgeTypeId)"/>
        public bool IsBuiltInParameter => ParameterUtils.IsBuiltInParameter(typeId);

        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.IsBuiltInGroup(Autodesk.Revit.DB.ForgeTypeId)"/>
        public bool IsBuiltInGroup => ParameterUtils.IsBuiltInGroup(typeId);

        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.GetBuiltInParameter(Autodesk.Revit.DB.ForgeTypeId)"/>
        ...
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.GetAllBuiltInParameters"/>
        [Pure]
        ...
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.GetAllBuiltInGroups"/>
        [Pure]
        ...
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.GetBuiltInParameterGroupTypeId(Autodesk.Revit.DB.ForgeTypeId)"/>
        [Pure]
...
#endif
#if REVIT2027_OR_GREATER
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.DownloadParameterOptions(Autodesk.Revit.DB.ForgeTypeId,System.String)"/>
        [Pure]
        ...
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.DownloadCompanyName(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ForgeTypeId,System.String)"/>
        [Pure]
        ...
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.DownloadParameter(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ParameterDownloadOptions,Autodesk.Revit.DB.ForgeTypeId,System.String)"/>
        [Pure]
    ...
    {
        /// <inheritdoc cref="Autodesk.Revit.DB.ParameterUtils.GetParameterTypeId(Autodesk.Revit.DB.BuiltInParameter)"/>
        [Pure]
